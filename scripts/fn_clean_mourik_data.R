  ...
  data <- data %>%
    mutate(
      ...
      common_id = case_when(
        ...
        is.na(common_id) == TRUE & full_name == 'BAS Vis'  ~ '16081996VIS',
        common_id == '25021987LANG1'                       ~ '25021987LANG',
        common_id == '2003179LOPE'                         ~ '20031979LOPE',
        common_id == '19051994ELSH'                        ~ '25091969ELSH',
        common_id == '20071875SANT'                        ~ '20071975SANT',
      ...
      full_name = case_when(
        ...
        full_name == 'Bojic C'                     ~ 'Bojic G',
        full_name == 'C Bektas'                    ~ 'Bektas C',
        full_name == 'Cemulini'                    ~ 'Cemulini L',
        ...
        full_name == 'Lopez Harteveld D'           ~ 'Lopez Harteveld',
